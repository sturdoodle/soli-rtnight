...
const V5Sidebar = ({
  ...
  return (
    <aside className={`hidden lg:flex ${isCollapsed ? 'w-24' : 'w-72'} border-r border-black/5 dark:border-white/5 bg-[var(--v5-bg)] flex-col pt-4 print:hidden transition-[width] duration-300 relative`}>
      <button

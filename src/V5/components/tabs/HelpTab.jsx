    ...
    <div className="space-y-8 px-1 sm:px-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="p-8 rounded-[3rem] bg-[var(--v5-card)]/30 border border-black/5 dark:border-white/5 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-[11px] text-slate-500 font-medium leading-relaxed max-w-xl">
            Welcome to the Resume Builder framework. Our platform is designed for high-velocity career building. Learn how to leverage the full power of our real-time optimization tools.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[
          ...
          { icon: Zap, title: "Real-time Auto-Save", desc: "Every keystroke is saved to your preferred storage mode instantly. Transitions between editor modes are non-destructive and low-latency.", color: "blue" },
          { icon: ShieldCheck, title: "Data Privacy & Security", desc: "Zero telemetry tracking. Your professional data never leaves your browser. We value data privacy above all else.", color: "emerald" },
      ...
      <div className="p-8 rounded-[3rem] bg-[#0ea5e9]/5 border border-[#0ea5e9]/10 flex flex-col items-center text-center">
        ...
        <p className="text-[10px] text-slate-500 font-medium leading-relaxed max-w-sm">
          The Resume Builder Core is our most stable build. Major updates are pushed quarterly with security patches as needed.
        </p>
      </div>
    </div>
  );

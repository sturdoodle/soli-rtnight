  ...
  return (
    <div className="space-y-8 px-1 sm:px-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="p-6 bg-black/5 dark:bg-white/5 rounded-3xl border border-dashed border-black/10 dark:border-white/10">
        <h3 className="text-xs font-black uppercase tracking-[0.2em] text-slate-400 mb-2">Snapshot Engine</h3>
        <p className="text-[10px] text-slate-500 font-medium leading-relaxed">
          Manage your career database. Exporting generates a portable JSON blueprint containing all resume versions and metadata. Importing a snapshot will restore all career nodes to that point in time.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h4 className="text-[11px] font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest mb-1">Backup Generator</h4>
              <p className="text-lg font-black text-[var(--v5-heading)] tracking-tight">Export Snapshot</p>
            </div>
          </div>
          <p className="text-[10px] text-slate-500 font-medium leading-relaxed mb-4">Download a complete architectural blueprint of your resume in portable JSON format. Perfect for cloud storage or sharing across systems.</p>
          <div className="text-[9px] font-black uppercase tracking-widest text-[#0ea5e9]">Generate Master Backup</div>
        </button>
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h4 className="text-[11px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest mb-1">Schema Restorer</h4>
              <p className="text-lg font-black text-[var(--v5-heading)] tracking-tight">Import Snapshot</p>
            </div>
          </div>
          <p className="text-[10px] text-slate-500 font-medium leading-relaxed mb-4">Restore your workspace from a previously exported JSON backup. This action will replace all current data with the snapshot payload.</p>
          <div className="text-[9px] font-black uppercase tracking-widest text-[#0ea5e9]">Load Blueprint Data</div>
          <input
      ...
      <div className="p-8 rounded-[3rem] bg-[var(--v5-card)]/30 border border-black/5 dark:border-white/5">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h4 className="text-[11px] font-black text-amber-500 uppercase tracking-widest mb-1">Storage Governance</h4>
            <h3 className="text-2xl font-black text-[var(--v5-heading)] tracking-tight">Data Policy</h3>
          </div>
      ...
      <div className="p-8 rounded-[3rem] bg-red-500/5 border border-red-500/10">
        <div className="flex items-center justify-between mb-2">
          <div>
            <h4 className="text-[11px] font-black text-red-600 dark:text-red-400 uppercase tracking-widest mb-1">Destructive Actions</h4>
        ...
        <p className="text-[11px] text-slate-500 font-medium leading-relaxed mb-6">Wiping the engine cache will reset all data nodes to factory defaults. This action cannot be undone unless you have a recent JSON backup.</p>
        <button

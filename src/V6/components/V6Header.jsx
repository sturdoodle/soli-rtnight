...
const V6Header = ({ onMenuClick, activeSection, onSectionChange, showPreview, onTogglePreview, isMobileView, onDownload }) => {
  ...
  return (
    <header className="h-20 border-b border-slate-200 dark:border-white/[0.06] bg-white/80 dark:bg-black/20 backdrop-blur-xl flex items-center justify-between px-3 sm:px-6 sticky top-0 z-40">

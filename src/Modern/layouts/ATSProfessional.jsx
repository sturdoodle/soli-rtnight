...
export const ATSProfessional = ({ data, themeColor, atsMode, sectionThemingEnabled }) => (
              ...
              <div key={exp.id}>
                ...
                {exp.clients?.map((client) => (
                  <div key={client.id} className="mt-1 mb-3">
                    {client.name && <div className="text-[12px] font-bold opacity-80 mb-1 transition-colors" style={atsMode ? {} : { color: sectionThemingEnabled ? themeColor : 'black' }}>{client.name}</div>}
